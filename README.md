...
This pipeline takes genomic and transcriptomic variation data such as SNP, INDEL, and Fusion, and call variant peptides from them using the graph-based algorithm [moPepGen](https://github.com/uclahs-cds/package-moPepGen)

---

## How To Run

1. Create sample-specific config file using the [template](config/template.config)
...
3. To run on UCSL-CDS' Azure clusters, see the submission script, [here](https://github.com/uclahs-cds/tool-submit-nf). For general usage, launch with the comamnd below:
