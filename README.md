...
> :information_source: Novel-ORF peptides and alt-translation peptides can be provided into this pipeline for splitting, encoding, and creating decoy databases. They can be generated using the [`callNovelORF`](https://uclahs-cds.github.io/package-moPepGen/call-novel-orf/) and [`callAltTranslation`](https://uclahs-cds.github.io/package-moPepGen/call-alt-translation/) command from moPepGen.
